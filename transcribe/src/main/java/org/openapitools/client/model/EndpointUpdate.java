 ...
 */
@JsonPropertyOrder({
  EndpointUpdate.JSON_PROPERTY_MODEL,
  EndpointUpdate.JSON_PROPERTY_PROPERTIES,
  EndpointUpdate.JSON_PROPERTY_DISPLAY_NAME,
  EndpointUpdate.JSON_PROPERTY_DESCRIPTION,
  EndpointUpdate.JSON_PROPERTY_CUSTOM_PROPERTIES,
  EndpointUpdate.JSON_PROPERTY_PROJECT
})
...
public class EndpointUpdate {
  ...
  @javax.annotation.Nullable
  private EndpointPropertiesUpdate properties;
  ...
  public EndpointUpdate model(@javax.annotation.Nullable EntityReference model) {
    this.model = model;
    return this;
  }
  ...
  public EndpointUpdate properties(@javax.annotation.Nullable EndpointPropertiesUpdate properties) {
  ...
  @JsonProperty(JSON_PROPERTY_PROPERTIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProperties(@javax.annotation.Nullable EndpointPropertiesUpdate properties) {
    this.properties = properties;
  }


  public EndpointUpdate displayName(@javax.annotation.Nullable String displayName) {
  ...
  public EndpointUpdate description(@javax.annotation.Nullable String description) {
  ...
  public EndpointUpdate customProperties(@javax.annotation.Nullable Map<String, String> customProperties) {
  ...
  public EndpointUpdate project(@javax.annotation.Nullable EntityReference project) {
  ...
  /**
   * Return true if this EndpointUpdate object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(model, properties, displayName, description, customProperties, project);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    public Builder() {
      this(new EndpointUpdate());
    }

    protected Builder(EndpointUpdate instance) {
      this.instance = instance;
    }

    public EndpointUpdate.Builder model(EntityReference model) {
      this.instance.model = model;
      return this;
    }
    public EndpointUpdate.Builder properties(EndpointPropertiesUpdate properties) {
      this.instance.properties = properties;
      return this;
    }
    public EndpointUpdate.Builder displayName(String displayName) {
      this.instance.displayName = displayName;
      return this;
    }
    public EndpointUpdate.Builder description(String description) {
      this.instance.description = description;
      return this;
    }
    public EndpointUpdate.Builder customProperties(Map<String, String> customProperties) {
      this.instance.customProperties = customProperties;
      return this;
    }
    public EndpointUpdate.Builder project(EntityReference project) {
    ...
    /**
    * returns a built EndpointUpdate instance.
    *
  ...
  */
  public static EndpointUpdate.Builder builder() {
    return new EndpointUpdate.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public EndpointUpdate.Builder toBuilder() {
    return new EndpointUpdate.Builder()
      .model(getModel())
