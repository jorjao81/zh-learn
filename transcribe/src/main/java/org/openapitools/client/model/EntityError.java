 ...
 */
@JsonPropertyOrder({
  EntityError.JSON_PROPERTY_CODE,
  EntityError.JSON_PROPERTY_MESSAGE
})
...
public class EntityError {
  ...
  /**
   * Return true if this EntityError object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    private EntityError instance;

    public Builder() {
      this(new EntityError());
    }

    protected Builder(EntityError instance) {
      this.instance = instance;
    }

    public EntityError.Builder code(String code) {
      this.instance.code = code;
      return this;
    }
    public EntityError.Builder message(String message) {
    ...
    /**
    * returns a built EntityError instance.
    *
    * The builder is not reusable.
    */
    public EntityError build() {
      try {
  ...
  */
  public static EntityError.Builder builder() {
    return new EntityError.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public EntityError.Builder toBuilder() {
    return new EntityError.Builder()
      .code(getCode())
      .message(getMessage());
  }
