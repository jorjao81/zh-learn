...
import requests
from .textual_audio_selector import TextualAudioSelector
...
class ForvoGenerator(AudioGenerator):
    ...
    def __init__(
        ...
        self.textual_selector = TextualAudioSelector(self._play_audio)
    ...
    def _select_best_pronunciation(self, pronunciations: List[Dict], text: str) -> Optional[Dict]:
        ...
        if self.interactive_selection:
            return self.textual_selector.select_pronunciation(text, pronunciations)
